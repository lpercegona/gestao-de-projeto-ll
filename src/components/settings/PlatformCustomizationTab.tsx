...
export const PlatformCustomizationTab: React.FC = () => {
        ...
        <CardHeader>
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <CardDescription>Configure o fuso horário para registro de horas</CardDescription>
            </div>
          </div>
        </CardHeader>
        <CardContent>
      ...
      {isMasterAdmin && (
        <div>
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-lg font-semibold">Personalização do Tema</h3>
          </div>
          <ThemeSettings />
        </div>
      )}
