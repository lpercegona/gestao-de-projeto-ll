      ...
      <div className="flex h-screen overflow-hidden bg-background">
        ...
        <main className="flex-1 flex flex-col h-screen overflow-hidden">
          ...
          <div className="flex-1 overflow-auto lg:pt-[58px] bg-secondary">
            <div className="min-h-full rounded-tl-[12px] rounded-tr-[12px] sm:rounded-tr-none bg-[hsl(var(--content-surface))] px-4 py-4 sm:px-6 sm:py-5 lg:px-8 bg-primary-foreground">
              {children}
            </div>
          </div>
        </main>
