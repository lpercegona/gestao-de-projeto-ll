...
import {
  HeaderTimerDisplay,
  HeaderTimerTaskInfo,
} from "@/components/timer/HeaderTimerDisplay";
...
const MobileHeader: React.FC<{
  ...
  return (
    <div className="sticky top-0 z-30 flex flex-shrink-0 items-center justify-between bg-muted/40 px-4 py-3 sm:px-6 lg:hidden">
      <div className="flex items-center gap-3 flex-1 overflow-hidden">
        <Button
          variant="ghost"
          size="icon"
          className="h-9 w-9 flex-shrink-0 text-muted-foreground hover:bg-accent"
...
const DesktopHeader: React.FC<{
  ...
  const { hasActiveTimer } = useGlobalTimer();
  return (
    <div className="fixed left-0 right-0 top-0 z-30 hidden h-14 bg-muted/40 lg:flex">
  ...
  return (
    <TooltipProvider delayDuration={0}>
      <div className="flex h-screen overflow-hidden bg-muted/40">
        ...
        <aside
          className={cn(
            "fixed inset-y-0 left-0 z-50 flex h-screen flex-col bg-muted/40 transition-all duration-300 lg:static",
        ...
        >
          ...
          >
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    ...
                    size="icon"
                    className={cn(
                      "absolute -right-4 top-1/2 z-10 hidden h-8 w-8 -translate-y-1/2 rounded-full border border-border bg-background text-muted-foreground shadow-sm transition-opacity duration-200 lg:flex",
            ...
            <Button
              variant="ghost"
              size="icon"
              className="absolute right-4 top-1/2 h-9 w-9 -translate-y-1/2 text-muted-foreground hover:bg-accent lg:hidden"
              onClick={() => setSidebarOpen(false)}
            >
                ...
                const NavLink = (
                  <Link
                    ...
                    className={cn(
                      ...
                      isCollapsed &&
                        "lg:justify-center lg:px-0 lg:h-8 lg:w-8 lg:mx-auto",
                    )}
                  >
          ...
          >
            ...
            {user && (
              ...
              >
                ...
                >
                  ...
                  <AvatarFallback className="bg-background text-foreground text-sm border border-border">
                    {getUserInitials()}
                  </AvatarFallback>
                </Avatar>
                <div
              ...
              <Tooltip>
                <TooltipTrigger asChild className="hidden lg:flex">
                  <Button
                    variant="ghost"
                    size="icon"
                    className="mx-auto h-8 w-8 text-muted-foreground hover:bg-accent hover:text-foreground"
                ...
                <Button
                  variant="ghost"
                  className="lg:hidden w-full justify-start text-muted-foreground hover:bg-accent hover:text-foreground"
                  onClick={handleSignOut}
                >
            ...
            <div
              className={cn(
                "px-3 py-2 text-xs text-muted-foreground/70",
                isCollapsed && "lg:hidden",
              )}
            >
              Versão 1.0
        ...
        <main className="flex-1 flex flex-col h-screen overflow-hidden">
          ...
          <div className="flex-1 overflow-auto lg:pt-[58px]">
            <div className="min-h-full rounded-tl-xl border-l border-border bg-background px-4 py-4 sm:px-6 sm:py-5 lg:px-8">
              {children}
            </div>
          </div>
        </main>
