...
const NavigationMenuList = React.forwardRef<
  React.ElementRef<typeof NavigationMenuPrimitiveList>,
  React.ComponentPropsWithoutRef<typeof NavigationMenuPrimitiveList>
>(({ className, ...props }, ref) => (
...
const NavigationMenuTrigger = React.forwardRef<
  React.ElementRef<typeof NavigationMenuPrimitiveTrigger>,
  React.ComponentPropsWithoutRef<typeof NavigationMenuPrimitiveTrigger>
>(({ className, children, ...props }, ref) => (
...
const NavigationMenuContent = React.forwardRef<
  React.ElementRef<typeof NavigationMenuPrimitiveContent>,
  React.ComponentPropsWithoutRef<typeof NavigationMenuPrimitiveContent>
>(({ className, ...props }, ref) => (
...
const NavigationMenuViewport = React.forwardRef<
  React.ElementRef<typeof NavigationMenuPrimitiveViewport>,
  React.ComponentPropsWithoutRef<typeof NavigationMenuPrimitiveViewport>
>(({ className, ...props }, ref) => (
...
NavigationMenuViewport.displayName = NavigationMenuPrimitiveViewport.displayName;

const NavigationMenuIndicator = React.forwardRef<
  React.ElementRef<typeof NavigationMenuPrimitiveIndicator>,
  React.ComponentPropsWithoutRef<typeof NavigationMenuPrimitiveIndicator>
>(({ className, ...props }, ref) => (
...
NavigationMenuIndicator.displayName = NavigationMenuPrimitiveIndicator.displayName;
