...
>(({ className, ...props }, ref) => (
  <SelectPrimitiveLabel ref={ref} className={cn("py-1.5 pl-8 pr-2 text-sm font-semibold", className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <SelectPrimitiveSeparator ref={ref} className={cn("-mx-1 my-1 h-px bg-muted", className)} {...props} />
));
