...
export const GlobalTimerCompleteDialog: React.FC<GlobalTimerCompleteDialogProps> = ({
  ...
  const pendingTaskLink = timerState.taskId;
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            ...
            {pendingTaskLink ? (
              <>
                <br />
                O vínculo com a tarefa será aplicado somente ao registrar este tempo.
              </>
            ) : null}
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 py-4">
          ...
          {linkMode === 'existing' && !pendingTaskLink && (
            <div className="space-y-2">
