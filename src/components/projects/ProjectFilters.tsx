      ...
      <div className="flex items-center gap-3">
        ...
        >
          <ToggleGroupItem
            ...
            className={cn(
              "h-6 px-2.5 text-xs font-medium text-[#64748b] rounded-full data-[state=on]:bg-[#e2e8f0] data-[state=on]:shadow-none",
            )}
          >
            <LayoutList className="w-3.5 h-3.5 mr-1.5" />
            Lista
          </ToggleGroupItem>
          <ToggleGroupItem value="kanban" aria-label="Visualização Kanban" className={cn("h-6 px-2.5")}>
