...
export const Landing: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Featured content */}
      <section
        className="pb-10 sm:pb-24 animate-fade-in"
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {loading ? (
            ...
            projects.length === 0 ? (
              <p className="text-xs sm:text-sm text-muted-foreground text-center py-12">
              ...
              {profiles.map((prof, index) => (
                ...
                >
                  ...
                  <div className="p-1.5 sm:p-2 space-y-0.5">
                    <h3 className="text-[10px] sm:text-xs font-semibold text-foreground line-clamp-1 group-hover:text-primary transition-colors">
                      {prof.full_name}
                    </h3>
                    {prof.company_name && (
